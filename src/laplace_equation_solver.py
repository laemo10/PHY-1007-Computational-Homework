            ...
            for y in range(np_field_end.shape[1]):
                for x in range(np_field_end.shape[0]):
                    if mask[x,y] == True:
                        ...
                        if x == 0 and y == 0:
                            np_field_end[x,y] = (np_field_end[x+1,y]+np_field_end[x,y+1])/4
                            ...
                            np_field_end[x,y] = (np_field_end[x+1,y]+np_field_end[x,y+1]+np_field_end[x,y-1])/4

                        elif x == (np_field_end.shape[0]-1) and y != (np_field_end.shape[1]-1):
                            np_field_end[x,y] = (np_field_end[x-1,y]+np_field_end[x,y+1]+np_field_end[x,y-1])/4

                        elif y == 0 and x != 0 :
                            np_field_end[x,y] = (np_field_end[x+1,y]+np_field_end[x-1,y]+np_field_end[x,y+1])/4
